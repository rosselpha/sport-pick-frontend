            ...
            <div className='bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center'>
                ...
                <div className="md:w-1/2 px-8 md:px-16">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        <input className="p-2 mt-8 rounded-xl border" type="email" name="email" placeholder="Email" defaultValue={email}  ref={emailRef}/>
                        <div className="relative">
                            <input className="p-2 rounded-xl border w-full" type="password" name="password" placeholder="Password" ref={passwordRef} />

                        </div>
                        <button type='submit' className="bg-[#5b21b6] rounded-xl text-white py-2 hover:scale-105 duration-300">sign up</button>
                    </form>
                    ...
                    <div className="mt-3 text-xs flex justify-between items-center text-[#5b21b6]">
                        ...
                        <Link href="/login"><button className="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300">login</button>  </Link>
